...
def translate_text(text):
    ...
    for chunk in chunks:
        response = openai.ChatCompletion.create(model="gpt-3.5-turbo", max_tokens=MAX_TOKENS_PER_REQUEST, messages=[{"role": "user", "content": f'Translate the following text to English keeping format and blank lines:\n\n{chunk}\n\nTranslation:'}])
